//Median of two Sorted Arrays of Different Sizes (B.S. on Answer Space)
import java.util.*;
public class U {
        ...
        //Approach-2: Simulating merge process of merge sort
        // TC = O(N1 + N2), SC = O(1)
        public static double median2(int[] a, int[] b){
            ...
            int cnt = 0;                // tracks position in the virtual merged array
            int idx1El =-1, idx2El =-1; // store elements at median positions
