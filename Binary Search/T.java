//Minimise Maximum Distance between Gas Stations (B.S. on Answer Space)
import java.util.*;
...
public class T {
        ...
        public static class Pair{
            double first;   // current max section length of a gap
            int second;     // index of that gap
        ...
        public static double minimizeMaxDistance2(int[] arr, int k){
            ...
            for(int gasStations = 1; gasStations <=k; gasStations++){
                ...
                double inidiff = arr[secIdx + 1] - arr[secIdx];  // original gap
